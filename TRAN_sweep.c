...
void TR_tran_SPARSE_LU_sweep(int iter, int k_value){
    ...
    if(iter == 1){
        SPARSE_TR_x_curr = (double*)calloc(tran_SPARSE_rows, sizeof(double));
        SPARSE_TR_x_prev = (double*)calloc(tran_SPARSE_rows, sizeof(double));
    ...
    tran_y_TR = (double*)cs_malloc(tran_SPARSE_rows, sizeof(double));
...
void tran_SPARSE_LU_sweep(int iter, int k_value){
    ...
    if(iter == 1){
        SPARSE_BE_x_curr = (double*)calloc(tran_SPARSE_rows, sizeof(double));
        SPARSE_BE_x_prev = (double*)calloc(tran_SPARSE_rows, sizeof(double));
    ...
    tran_y = (double*)cs_malloc(tran_SPARSE_rows, sizeof(double));
